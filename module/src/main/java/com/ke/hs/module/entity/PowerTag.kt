...
import com.ke.hs.module.db.ZonePositionChangedEvent
...
sealed interface PowerTag {
    ...
    sealed interface PowerTaskList : PowerTag {
        ...
        data class TagChange(
            ...
            //没有 card_id
            //TAG_CHANGE Entity=[entityName=UNKNOWN ENTITY [cardType=INVALID] id=171 zone=DECK zonePos=0 cardId= player=2] tag=REVEALED value=0
//            override fun isUpdateZone(userPlayerId: Int?): ZonePositionChangedEvent? {
//                if (tag == "REVEALED" && value == "0") {
//                    //SHOW_ENTITY - Updating Entity=[entityName=UNKNOWN ENTITY [cardType=INVALID] id=117 zone=DECK zonePos=0 cardId= player=1] CardID=TTN_450t2
...
//                }
//
//                return super.isUpdateZone(userPlayerId)
//            }
        }
...
//            }
        ...
        data class ShowEntity(
            ...
            /**
             * SHOW_ENTITY - Updating Entity=[entityName=UNKNOWN ENTITY [cardType=INVALID] id=171 zone=DECK zonePos=0 cardId= player=2] CardID=WW_372t
             * D 21:49:18.7295580 PowerTaskList.DebugPrintPower() -         tag=CONTROLLER value=2
             * D 21:49:18.7295580 PowerTaskList.DebugPrintPower() -         tag=CARDTYPE value=SPELL
             * D 21:49:18.7295580 PowerTaskList.DebugPrintPower() -         tag=TAG_LAST_KNOWN_COST_IN_HAND value=6
             * D 21:49:18.7295580 PowerTaskList.DebugPrintPower() -         tag=COST value=6
             * D 21:49:18.7295580 PowerTaskList.DebugPrintPower() -         tag=ZONE value=DECK
             * D 21:49:18.7295580 PowerTaskList.DebugPrintPower() -         tag=ENTITY_ID value=171
             * D 21:49:18.7295580 PowerTaskList.DebugPrintPower() -         tag=ELITE value=1
             * D 21:49:18.7295580 PowerTaskList.DebugPrintPower() -         tag=CREATOR value=17
             * D 21:49:18.7295580 PowerTaskList.DebugPrintPower() -         tag=DISPLAYED_CREATOR value=17
             * D 21:49:18.7295580 PowerTaskList.DebugPrintPower() -         tag=REVEALED value=1
             * D 21:49:18.7295580 PowerTaskList.DebugPrintPower() -         tag=1037 value=1
             * D 21:49:18.7295580 PowerTaskList.DebugPrintPower() -         tag=1068 value=0
             * D 21:49:18.7295580 PowerTaskList.DebugPrintPower() -         tag=CASTS_WHEN_DRAWN value=1
             * D 21:49:18.7295580 PowerTaskList.DebugPrintPower() -         tag=CREATOR_DBID value=101367
             * D 21:49:18.7295580 PowerTaskList.DebugPrintPower() -         tag=SPAWN_TIME_COUNT value=1
             */
            override fun isUpdateZone(userPlayerId: Int?): ZonePositionChangedEvent? {

                //战士的工头塞炸弹 无中生有往牌库塞牌
                if (payloads["REVEALED"] == "1" && getZoneString() == "DECK" && payloads["1043"] != "1") {
